...
- Frontend unit tests: 54 passed. Backend: 132 passed across 17 files with PostgreSQL and MQTT enabled.
- PostgreSQL (5433) and MQTT (1884) healthy; all eight existing migrations applied.
...
- [ ] Persisted energy policy/history and simulator dispatch.
- [ ] In-app notifications and account security states.
- [ ] Full-stack browser journey: isolated test auth, PostgreSQL, MQTT.
- [ ] Lint, types, tests, builds, migrations and documentation.
- [ ] Verified milestone commits and origin pushes.

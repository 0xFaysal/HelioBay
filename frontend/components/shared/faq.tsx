...
["Can I use the demo with real equipment?","No. Demo Mode is a browser-local simulation with fictional credits and labelled digital-twin energy. API Mode needs a verified backend, payment provider and ESP32 integration. Always follow the physical charger’s safety instructions."],

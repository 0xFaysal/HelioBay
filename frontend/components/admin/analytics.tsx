...
export function AdminAnalytics() {
  ...
  return <>
    ...
    <div className="dashboard-grid mt-6"><section className="panel"><h2 className="panel-title mb-5">Solar & energy delivered</h2><Chart data={points} label="EV-equivalent energy in kWh" series={[{ key: "solar", name: "Solar", color: "#00af5a" }, { key: "demand", name: "Delivered", color: "#65716b" }]} /></section><section className="panel"><h2 className="panel-title mb-5">Simulated revenue</h2><Chart data={points} label="Net receipts in taka" series={[{ key: "revenue", name: "Net receipts", color: "#197a4a" }]} /></section><section className="panel"><h2 className="panel-title mb-5">Generation, grid backup & export</h2><Chart data={points} label="Retained meter history in Wh; independent of EV-equivalent scaling" series={[{ key: "generationWh", name: "Solar generation", color: "#00af5a" }, { key: "gridBackupWh", name: "Grid backup", color: "#b58229" }, { key: "exportWh", name: "Grid export", color: "#65716b" }]} /></section><section className="panel"><h2 className="panel-title mb-5">Session count & duration</h2><Chart data={points} label="Session count and average simulated minutes" series={[{ key: "sessions", name: "Sessions", color: "#197a4a" }, { key: "duration", name: "Avg. minutes", color: "#65716b" }]} /></section></div>

...
export const resourcePayment = z.object({transactionId:z.string(),userId:z.string(),status:z.enum(["PENDING","VALIDATING","PAID","VERIFIED","FAILED","CANCELLED","EXPIRED","RISK_REVIEW","REVERSED"]),amountMinor:minorText,provider:z.enum(["SSLCOMMERZ","LOCAL_SANDBOX"]).default("SSLCOMMERZ"),isSandbox:z.boolean(),createdAt:iso,verifiedAt:iso.nullable(),providerReference:nullableText.optional(),GatewayPageURL:nullableText.optional()});
